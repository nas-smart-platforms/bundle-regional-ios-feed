...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Feed",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Feed25ChannelListViewController")
...
@interface ChannelListViewController (SWIFT_EXTENSION(Feed)) <UITableViewDelegate>
